...
class TestUserUniquenessProperties:
    ...
    def test_user_uniqueness_and_role_management_property(self, user1_data, user2_data, role_data):
        """
        ...
        **Validates: Requirements 6.1, 6.4**
        ...
        try:
            ...
            if (user2_data['username'] != user1_data['username'] and 
            ...
            if user2_data['email'] == user1_data['email']:
                ...
                try:
                    duplicate_email_user = User(
                        username=user2_data['username'] + "_different",  # Different username
    ...
    @settings(max_examples=10)
    def test_role_modification_updates_permissions(self, user_data, role1_data, role2_data):
        """
