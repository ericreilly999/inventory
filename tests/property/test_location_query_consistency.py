...
@given(
    ...
    child_counts=st.lists(st.integers(min_value=0, max_value=3), min_size=1, max_size=5)
)
    ...
    try:
        ...
        for parent_item in queried_parent_items:
            for child_item in parent_item.child_items:
                ...
                assert child_item.parent_item.current_location_id == parent_item.current_location_id
