...
class TestLocationValidation:
    ...
    def test_validate_location_type_deletion_with_locations_should_raise_error(self):
    ...
    def test_validate_location_type_deletion_without_locations_should_pass(self):
...
class TestLocationRetrieval:
    ...
    async def test_get_location_type_by_id_existing_type(self):
        ...
        mock_db.query.return_value.filter.return_value.first.return_value = mock_location_type
    ...
    async def test_get_location_type_by_id_nonexistent_type(self):
        ...
        assert exc_info.value.status_code == 404
        assert f"Location type with id {location_type_id} not found" in exc_info.value.detail
...
class TestLocationModification:
    ...
    def test_location_update_metadata(self):
        ...
        # Act
        location.location_metadata = {"capacity": 1000, "temperature_controlled": True}
