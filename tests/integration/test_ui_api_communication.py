...
class TestUIAPICommunication:
    ...
    def test_user_management_endpoints(self, api_base_url: str, auth_headers: Dict[str, str]):
    ...
    def test_error_response_format(self, api_base_url: str):
        ...
        try:
            response = requests.get(
                f"{api_base_url}/api/v1/invalid-endpoint",
                timeout=10
            )
...
class TestUIErrorHandling:
    ...
    def test_large_payload_handling(self, api_base_url: str, auth_headers: Dict[str, str]):
