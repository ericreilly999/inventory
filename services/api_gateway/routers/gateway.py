...
async def register(request: Request, client: httpx.AsyncClient = Depends(get_service_client)):
    """Route register request to user service."""
    return await route_request(request, "user", "/auth/register", client)


@router.post("/auth/logout")
async def logout(request: Request, client: httpx.AsyncClient = Depends(get_service_client)):
...
async def users_routes(request: Request, path: str, client: httpx.AsyncClient = Depends(get_service_client)):
...
async def roles_routes(request: Request, path: str, client: httpx.AsyncClient = Depends(get_service_client)):
...
async def admin_routes(request: Request, path: str, client: httpx.AsyncClient = Depends(get_service_client)):
...
async def items_routes(request: Request, path: str, client: httpx.AsyncClient = Depends(get_service_client)):
...
async def locations_routes(request: Request, path: str, client: httpx.AsyncClient = Depends(get_service_client)):
...
async def movements_routes(request: Request, path: str, client: httpx.AsyncClient = Depends(get_service_client)):
...
async def reports_routes(request: Request, path: str, client: httpx.AsyncClient = Depends(get_service_client)):
